...
import delete_stock_router from "./deleteProduct.js";
import profile_view_router from "./profileView.js";
...
index_views_router.use('/delete_product', delete_stock_router)
index_views_router.use('/profile',profile_view_router)
